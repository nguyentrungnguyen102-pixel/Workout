...
export const PHASE_HISTORY = [
  ...
  { version: '5.0.0', phase: 5, summary: 'Home dumbbell exercises (20 presets), dumbbell category filter, volume progressive overload tracking, notification removal (Expo Go compat)' },
  {
    ...
    phase: 5,
    summary:
      'Hotfix: fully removed orphaned notification pipeline left over from 5.0.0 — deleted dead notificationService.ts, saveFcmToken, fcmToken/reminderEnabled/reminderTime fields, the unreachable sendSmartReminders Cloud Function + notificationBuilder, and unused expo-notifications/expo-device deps',
  },
] as const;
