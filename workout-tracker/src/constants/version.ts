...
export const PHASE_HISTORY = [
  ...
  { version: '5.0.1', phase: 5, summary: 'Hotfix: deleted the now-fully-dead notificationService.ts (no-op stub left over from the v5.0.0 removal, unreferenced by any screen)' },
] as const;
