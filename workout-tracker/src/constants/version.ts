...
export const PHASE_HISTORY = [
  ...
  { version: '5.1.0', phase: 5, summary: 'Hotfix: removed dead notification code (expo-notifications, expo-device deps, notificationService.ts, unused reminderEnabled/reminderTime/fcmToken fields) left over from the v5.0.0 removal' },
] as const;
