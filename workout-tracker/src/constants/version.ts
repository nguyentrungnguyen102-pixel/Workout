...
export const PHASE_HISTORY = [
  ...
  { version: '5.0.0', phase: 5, summary: 'Home dumbbell exercises (10 exercises), dumbbell category + badge, 2 dumbbell programs (3x beginner, 4x intermediate), removed broken notification UI' },
] as const;
