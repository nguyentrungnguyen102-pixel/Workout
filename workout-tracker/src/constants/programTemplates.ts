...
export const PROGRAM_TEMPLATES: WorkoutProgram[] = [
  ...
  {
    id: 'dumbbell_home_beginner',
    nameVi: 'Tạ Đơn Tại Nhà - Cơ Bản',
    descriptionVi: 'Luyện tập với tạ đơn tại nhà, 3 buổi/tuần. Phù hợp người mới bắt đầu dùng tạ.',
    emoji: '🏋️',
    daysPerWeek: 3,
    difficulty: 'beginner',
    focus: 'strength',
    ...
    days: [
      {
        ...
        exercises: [
          ...
          { presetId: 'db_overhead_press', nameVi: 'Đẩy vai trên đầu', sets: 3, reps: 12, unit: 'reps' },
          { presetId: 'db_bicep_curl',     nameVi: 'Cuộn tay trước',   sets: 3, reps: 12, unit: 'reps' },
          { presetId: 'db_tricep_kick',    nameVi: 'Tay sau tạ đơn',   sets: 3, reps: 12, unit: 'reps' },
        ],
      },
      {
        id: 'dhb_b',
        ...
        emoji: '🤸',
        exercises: [
          { presetId: 'db_bent_row',       nameVi: 'Rowing lưng',    sets: 3, reps: 12, unit: 'reps' },
          ...
          { presetId: 'db_hammer_curl',    nameVi: 'Cuộn búa',       sets: 3, reps: 12, unit: 'reps' },
        ],
      },
      {
        id: 'dhb_c',
        ...
        emoji: '🦵',
        exercises: [
          { presetId: 'db_goblet_squat', nameVi: 'Squat tạ đơn',       sets: 4, reps: 15, unit: 'reps' },
          { presetId: 'db_lunge',        nameVi: 'Lunge tạ đơn',        sets: 3, reps: 12, unit: 'reps' },
  ...
  {
    id: 'dumbbell_home_intermediate',
    nameVi: 'Tạ Đơn Tại Nhà - Nâng Cao',
    descriptionVi: 'Chương trình tạ đơn 4 buổi/tuần cho người đã quen tập. Tối ưu từng nhóm cơ.',
    emoji: '💪',
    daysPerWeek: 4,
    difficulty: 'intermediate',
    focus: 'strength',
    ...
    days: [
      {
        id: 'dhi_push',
        order: 1,
        nameVi: 'Ngày Đẩy — Ngực & Vai & Tay Trước',
        focusVi: 'Ngực · Vai trước · Tay trước',
        emoji: '💪',
        exercises: [
          { presetId: 'db_chest_press',    nameVi: 'Đẩy ngực tạ đơn',  sets: 4, reps: 12, unit: 'reps' },
          { presetId: 'db_overhead_press', nameVi: 'Đẩy vai trên đầu',  sets: 4, reps: 10, unit: 'reps' },
          { presetId: 'db_lateral_raise',  nameVi: 'Nâng ngang vai',    sets: 3, reps: 15, unit: 'reps' },
          { presetId: 'db_bicep_curl',     nameVi: 'Cuộn tay trước',    sets: 3, reps: 12, unit: 'reps' },
          { presetId: 'db_tricep_kick',    nameVi: 'Tay sau tạ đơn',    sets: 3, reps: 12, unit: 'reps' },
        ],
      },
      {
        id: 'dhi_pull',
        order: 2,
        nameVi: 'Ngày Kéo — Lưng & Tay Sau',
        focusVi: 'Lưng · Tay sau · Vai sau',
        emoji: '🤸',
        exercises: [
          { presetId: 'db_bent_row',      nameVi: 'Rowing lưng',     sets: 4, reps: 12, unit: 'reps' },
          { presetId: 'db_hammer_curl',   nameVi: 'Cuộn búa',        sets: 4, reps: 12, unit: 'reps' },
          { presetId: 'db_front_raise',   nameVi: 'Nâng trước vai',  sets: 3, reps: 12, unit: 'reps' },
          { presetId: 'db_lateral_raise', nameVi: 'Nâng ngang vai',  sets: 3, reps: 15, unit: 'reps' },
        ],
      },
      {
        id: 'dhi_legs',
        order: 3,
        nameVi: 'Ngày Chân — Đùi & Mông',
        focusVi: 'Đùi · Mông · Bắp chân',
        emoji: '🦵',
        exercises: [
          { presetId: 'db_goblet_squat', nameVi: 'Squat tạ đơn',    sets: 4, reps: 15, unit: 'reps' },
          { presetId: 'db_sumo_squat',   nameVi: 'Sumo Squat tạ đơn', sets: 4, reps: 12, unit: 'reps' },
          { presetId: 'db_rdl',          nameVi: 'Deadlift tạ đơn',  sets: 4, reps: 12, unit: 'reps' },
          { presetId: 'db_lunge',        nameVi: 'Lunge tạ đơn',     sets: 3, reps: 12, unit: 'reps' },
        ],
      },
      {
        id: 'dhi_full',
        order: 4,
        nameVi: 'Ngày Toàn Thân — Cardio & Core',
        focusVi: 'Toàn thân · Core · Đốt mỡ',
        emoji: '🔥',
        exercises: [
          { presetId: 'db_goblet_squat',   nameVi: 'Squat tạ đơn',     sets: 3, reps: 20, unit: 'reps' },
          { presetId: 'db_chest_press',    nameVi: 'Đẩy ngực tạ đơn',  sets: 3, reps: 15, unit: 'reps' },
          { presetId: 'db_bent_row',       nameVi: 'Rowing lưng',       sets: 3, reps: 15, unit: 'reps' },
          { presetId: 'burpee',            nameVi: 'Burpee',            sets: 3, reps: 10, unit: 'reps' },
          { presetId: 'plank',             nameVi: 'Plank',             sets: 3, durationSeconds: 60, unit: 'seconds' },
        ],
      },
