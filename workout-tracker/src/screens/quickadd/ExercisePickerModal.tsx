...
const createStyles = StyleSheet.create({
  ...
  iconBtnActive: { borderColor: COLORS.primary, backgroundColor: COLORS.primaryDark },
  ...
  optionBtnActive: { backgroundColor: COLORS.primaryDark, borderColor: COLORS.primary },
