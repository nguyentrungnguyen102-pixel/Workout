...
export const SYSTEM_PRESETS: WorkoutPreset[] = [
  ...
  // Dumbbell (home training) — Phase 14, lấp nhóm Bụng/Ngực còn quá mỏng
  // trong danh mục tạ đơn (trước đó Bụng chỉ có 1 bài, Ngực chỉ có 2)
  { id: 'db_russian_twist',    name: 'DB Russian Twist',   nameVi: 'Xoay người có tạ (bụng xéo)', category: 'dumbbell', unit: 'reps', defaultValue: 20, defaultSets: 3, icon: '🌪️', isCustom: false, usageCount: 0, muscleGroup: 'core' },
