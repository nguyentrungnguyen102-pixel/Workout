...
export const SYSTEM_PRESETS: WorkoutPreset[] = [
  ...
  // Dumbbell (home training) — Phase 15, 3 bài đơn giản dễ tập cho người mới:
  // động tác nhún vai (nhóm vai/thang còn thiếu), dead bug và suitcase carry
  // (bụng chỉ có 1 bài trước đó — db_side_bend)
  ...
  { id: 'db_suitcase_carry',   name: 'Suitcase Carry',     nameVi: 'Đi bộ mang tạ một tay (bụng/cầm nắm)', category: 'dumbbell', unit: 'seconds', defaultValue: 30, defaultSets: 3, icon: '💼', isCustom: false, usageCount: 0, muscleGroup: 'core' },
