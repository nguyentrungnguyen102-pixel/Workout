...
export const SYSTEM_PRESETS: WorkoutPreset[] = [
  ...
  // Dumbbell (home training) — Phase 14, bài tạ đơn giản cho người mới hoàn
  // toàn: chỉ cần 1 quả tạ, đứng tại chỗ, không cần nằm sàn/dụng cụ thêm
  { id: 'db_halo',              name: 'Dumbbell Halo',      nameVi: 'Xoay tạ quanh đầu (vai/core)', category: 'dumbbell', unit: 'reps', defaultValue: 10, defaultSets: 2, icon: '😇', isCustom: false, usageCount: 0, muscleGroup: 'shoulders' },
  { id: 'db_suitcase_carry',    name: 'Suitcase Carry',     nameVi: 'Xách tạ một tay (core/cầm nắm)', category: 'dumbbell', unit: 'seconds', defaultValue: 30, defaultSets: 2, icon: '💼', isCustom: false, usageCount: 0, muscleGroup: 'core' },
  { id: 'db_shrug',             name: 'Dumbbell Shrug',     nameVi: 'Nhún vai tạ (cầu vai)', category: 'dumbbell', unit: 'reps', defaultValue: 15, defaultSets: 2, icon: '🤷', isCustom: false, usageCount: 0, muscleGroup: 'shoulders' },
  { id: 'db_standing_twist',    name: 'Standing Dumbbell Twist', nameVi: 'Xoay hông cầm tạ (eo)', category: 'dumbbell', unit: 'reps', defaultValue: 20, defaultSets: 2, icon: '🔄', isCustom: false, usageCount: 0, muscleGroup: 'core' },
