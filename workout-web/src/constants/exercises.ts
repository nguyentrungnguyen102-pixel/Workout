...
export const SYSTEM_PRESETS: WorkoutPreset[] = [
  ...
  { id: 'db_calf_raise',       name: 'Calf Raise',         nameVi: 'Nâng gót tạ (bắp chân)', category: 'dumbbell', unit: 'reps', defaultValue: 20, defaultSets: 3, icon: '🦶', isCustom: false, usageCount: 0 },
  { id: 'db_skull_crusher',    name: 'Skull Crusher',      nameVi: 'Ép tạ nằm (tay sau)',    category: 'dumbbell', unit: 'reps', defaultValue: 12, defaultSets: 3, icon: '💀', isCustom: false, usageCount: 0 },
  { id: 'db_wrist_curl',       name: 'Wrist Curl',         nameVi: 'Gập cổ tay tạ (cẳng tay)', category: 'dumbbell', unit: 'reps', defaultValue: 15, defaultSets: 3, icon: '✊', isCustom: false, usageCount: 0 },
  { id: 'db_side_bend',        name: 'Side Bend',          nameVi: 'Nghiêng hông tạ (eo)',   category: 'dumbbell', unit: 'reps', defaultValue: 15, defaultSets: 3, icon: '〰️', isCustom: false, usageCount: 0 },
  { id: 'db_curtsy_lunge',     name: 'Curtsy Lunge',       nameVi: 'Lunge chéo tạ (đùi trong/mông)', category: 'dumbbell', unit: 'reps', defaultValue: 12, defaultSets: 3, icon: '🦵', isCustom: false, usageCount: 0 },
  { id: 'db_single_leg_deadlift', name: 'Single Leg Deadlift', nameVi: 'Deadlift một chân tạ (thăng bằng/mông)', category: 'dumbbell', unit: 'reps', defaultValue: 10, defaultSets: 3, icon: '🧍', isCustom: false, usageCount: 0 },
