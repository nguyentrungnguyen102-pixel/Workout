...
export const PHASE_HISTORY = [
  ...
  { version: '2.12.0', phase: 9, summary: 'Bổ sung 6 bài tạ đơn tại nhà (Farmer\'s Carry, Renegade Row, Pullover, Concentration Curl, Step Up, Thruster) kèm hướng dẫn/icon/MET; sửa lỗi thông báo PR mới không bao giờ ghi nhận cho bài tự tạo đơn vị km (chạy/đạp xe theo quãng đường) — thiếu nhánh tính khoảng cách trong prService' },
] as const;
