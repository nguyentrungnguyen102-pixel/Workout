...
export const PROGRAM_TEMPLATES: WorkoutProgram[] = [
  ...
  {
    id: 'dumbbell_beginner_2x',
    nameVi: 'Tạ Đơn Người Mới 2x',
    descriptionVi: 'Chương trình nhập môn tạ đơn. Chỉ 2 buổi/tuần, phù hợp người chưa từng tập tạ.',
    emoji: '🌱',
    daysPerWeek: 2,
    difficulty: 'beginner',
    focus: 'strength',
    ...
    days: [
      {
        id: 'db2_a',
        order: 1,
        nameVi: 'Buổi A – Thân Trên',
        focusVi: 'Ngực · Vai · Tay trước + sau',
        emoji: '💪',
        exercises: [
          { presetId: 'db_chest_press',    nameVi: 'Đẩy tạ nằm sàn (ngực)',    sets: 3, reps: 10, unit: 'reps' },
          { presetId: 'db_shoulder_press', nameVi: 'Đẩy tạ đôi (vai)',          sets: 3, reps: 10, unit: 'reps' },
          { presetId: 'db_bicep_curl',     nameVi: 'Curl tạ đơn (bắp tay)',     sets: 3, reps: 10, unit: 'reps' },
          { presetId: 'db_tricep_ext',     nameVi: 'Giơ tạ sau đầu (tay sau)',  sets: 3, reps: 10, unit: 'reps' },
        ],
      },
      {
        id: 'db2_b',
        order: 2,
        nameVi: 'Buổi B – Thân Dưới',
        focusVi: 'Đùi · Mông · Lưng + Core',
        emoji: '🦵',
        exercises: [
          { presetId: 'db_goblet_squat', nameVi: 'Squat ôm tạ (đùi)',              sets: 3, reps: 12, unit: 'reps' },
          { presetId: 'db_rdl',          nameVi: 'Deadlift tạ Romania (sau đùi)',  sets: 3, reps: 12, unit: 'reps' },
          { presetId: 'db_bent_row',     nameVi: 'Kéo tạ cúi người (lưng)',       sets: 3, reps: 10, unit: 'reps' },
  ...
  {
    id: 'dumbbell_4day_split',
    nameVi: 'Tạ Đơn 4 Ngày/Tuần',
    descriptionVi: 'Chương trình tạ đơn tại nhà trung cấp. Tách nhóm cơ rõ ràng, tăng tải từng tuần.',
    emoji: '🔥',
    daysPerWeek: 4,
    difficulty: 'intermediate',
    focus: 'strength',
    ...
    days: [
      {
        ...
        exercises: [
          ...
          { presetId: 'db_chest_fly',      nameVi: 'Bay tạ nằm sàn (ngực)',        sets: 3, reps: 12, unit: 'reps' },
          { presetId: 'db_shoulder_press', nameVi: 'Đẩy tạ đôi (vai)',             sets: 4, reps: 10, unit: 'reps' },
          { presetId: 'db_lateral_raise',  nameVi: 'Nâng tạ ngang vai',            sets: 3, reps: 15, unit: 'reps' },
          { presetId: 'db_tricep_ext',     nameVi: 'Giơ tạ sau đầu (tay sau)',     sets: 3, reps: 12, unit: 'reps' },
        ],
      },
      {
        ...
        exercises: [
          ...
          { presetId: 'db_bicep_curl',     nameVi: 'Curl tạ đơn (bắp tay)',       sets: 3, reps: 12, unit: 'reps' },
          { presetId: 'db_hammer_curl',    nameVi: 'Curl búa (bắp tay)',          sets: 3, reps: 12, unit: 'reps' },
          { presetId: 'db_reverse_fly',    nameVi: 'Bay tạ ngược (vai sau)',      sets: 3, reps: 12, unit: 'reps' },
        ],
      },
      {
        id: 'db4_legs',
      ...
      },
      {
        id: 'db4_core',
        order: 4,
        nameVi: 'Ngày Core + Full',
        focusVi: 'Core · Toàn thân · Cardio nhẹ',
        emoji: '🔄',
        exercises: [
          ...
          { presetId: 'plank',             nameVi: 'Plank',                        sets: 3, durationSeconds: 60, unit: 'seconds' },
          { presetId: 'russian_twist',     nameVi: 'Xoay hông',                   sets: 3, reps: 20, unit: 'reps' },
          { presetId: 'mountain_climber',  nameVi: 'Leo núi',                     sets: 3, reps: 30, unit: 'reps' },
        ],
      },
    ],
  },
