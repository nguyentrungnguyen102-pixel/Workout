...
export const PROGRAM_TEMPLATES: WorkoutProgram[] = [
  ...
  {
    id: 'db_fullbody_4x',
    nameVi: 'Tạ Đơn Toàn Thân 4x/Tuần',
    descriptionVi: 'Chương trình tạ đơn toàn thân 4 buổi/tuần. Thay thế gym hoàn toàn chỉ với 1 đôi tạ tại nhà. Phù hợp từ người mới đến trung cấp.',
    emoji: '🏋️',
    daysPerWeek: 4,
    difficulty: 'intermediate',
    focus: 'strength',
    ...
    days: [
      {
        ...
        order: 1,
        nameVi: 'Ngực · Vai · Tay sau',
        focusVi: 'Ngực · Vai · Tricep (ngày đẩy)',
        emoji: '💪',
        exercises: [
          { presetId: 'db_chest_press',      nameVi: 'Đẩy tạ nằm sàn (ngực)',       sets: 3, reps: 12, unit: 'reps' },
          { presetId: 'db_chest_fly',        nameVi: 'Bay tạ nằm sàn (ngực)',        sets: 3, reps: 12, unit: 'reps' },
          { presetId: 'db_shoulder_press',   nameVi: 'Đẩy tạ đôi (vai)',             sets: 3, reps: 10, unit: 'reps' },
          { presetId: 'db_lateral_raise',    nameVi: 'Nâng tạ ngang vai',            sets: 3, reps: 15, unit: 'reps' },
          { presetId: 'db_tricep_ext',       nameVi: 'Giơ tạ sau đầu (tay sau)',     sets: 3, reps: 12, unit: 'reps' },
      ...
      },
      {
        id: 'dbfb_d2',
        order: 2,
        nameVi: 'Lưng · Bắp tay · Core',
        focusVi: 'Lưng · Bicep · Core (ngày kéo)',
        emoji: '🤸',
        exercises: [
          { presetId: 'db_bent_row',          nameVi: 'Kéo tạ cúi người (lưng)',     sets: 3, reps: 12, unit: 'reps' },
          { presetId: 'db_single_arm_row',    nameVi: 'Kéo tạ một tay (lưng)',       sets: 3, reps: 12, unit: 'reps' },
          { presetId: 'db_bicep_curl',        nameVi: 'Curl tạ đơn (bắp tay)',       sets: 3, reps: 12, unit: 'reps' },
          { presetId: 'db_concentration_curl',nameVi: 'Curl tập trung (đỉnh bắp)',   sets: 3, reps: 12, unit: 'reps' },
          { presetId: 'db_shrug',             nameVi: 'Nhún vai tạ (cơ thang)',      sets: 3, reps: 15, unit: 'reps' },
          { presetId: 'plank',                nameVi: 'Plank',                        sets: 3, durationSeconds: 45, unit: 'seconds' },
        ],
      },
      {
        id: 'dbfb_d3',
        order: 3,
        nameVi: 'Đùi · Mông · Bắp chân',
        focusVi: 'Đùi trước · Mông · Bắp chân (ngày chân)',
        emoji: '🦵',
        exercises: [
          { presetId: 'db_goblet_squat',  nameVi: 'Squat ôm tạ (đùi)',              sets: 4, reps: 15, unit: 'reps' },
          { presetId: 'db_lunge',         nameVi: 'Lunge tạ (đùi mông)',            sets: 3, reps: 12, unit: 'reps' },
          { presetId: 'db_sumo_squat',    nameVi: 'Squat sumo tạ (mông trong đùi)', sets: 3, reps: 15, unit: 'reps' },
          { presetId: 'db_rdl',           nameVi: 'Deadlift Romania (sau đùi)',      sets: 3, reps: 12, unit: 'reps' },
          { presetId: 'db_hip_thrust',    nameVi: 'Hip thrust tạ (mông)',           sets: 3, reps: 15, unit: 'reps' },
          { presetId: 'db_calf_raise_db', nameVi: 'Kiễng gót tạ (bắp chân)',       sets: 3, reps: 20, unit: 'reps' },
        ],
      },
      {
        id: 'dbfb_d4',
        order: 4,
        nameVi: 'Toàn thân · Vai · Core',
        focusVi: 'Toàn thân · Vai tròn · Core mạnh',
        emoji: '⚡',
        exercises: [
          ...
          { presetId: 'db_pullover',       nameVi: 'Kéo tạ sau đầu nằm (ngực/lưng)', sets: 3, reps: 12, unit: 'reps' },
          { presetId: 'db_side_bend',      nameVi: 'Nghiêng người tạ (hông)',      sets: 3, reps: 15, unit: 'reps' },
