...
export const PROGRAM_TEMPLATES: WorkoutProgram[] = [
  ...
  // Phase 6 — Advanced home dumbbell program
  {
    id: 'dumbbell_ppl_5x',
    nameVi: 'Tạ Đơn PPL 5 ngày/tuần',
    descriptionVi: 'Push-Pull-Legs với tạ đơn tại nhà. 5 buổi/tuần, nâng cao tăng cơ tối ưu.',
    emoji: '💥',
    daysPerWeek: 5,
    difficulty: 'advanced',
    focus: 'strength',
    ...
    days: [
      {
        id: 'db5_push',
        order: 1,
        nameVi: 'Ngày Đẩy — Ngực · Vai · Tricep',
      ...
      },
      {
        id: 'db5_pull',
        order: 2,
        nameVi: 'Ngày Kéo — Lưng · Bicep · Vai sau',
        ...
        exercises: [
          ...
          { presetId: 'db_bicep_curl',    nameVi: 'Curl tạ đơn (bắp tay)',        sets: 4, reps: 12, unit: 'reps' },
      ...
      },
      {
        id: 'db5_legs',
        order: 3,
        nameVi: 'Ngày Chân — Đùi · Mông · Bắp chân',
        focusVi: 'Đùi · Mông · Bắp chân',
        emoji: '🦵',
        exercises: [
      ...
      },
      {
        id: 'db5_upper',
        order: 4,
        nameVi: 'Thân Trên — Vai · Arnold · Core',
        focusVi: 'Vai · Ngực · Lưng · Core',
        emoji: '🙆',
        exercises: [
          { presetId: 'db_arnold_press',  nameVi: 'Arnold press (vai)',             sets: 4, reps: 10, unit: 'reps' },
      ...
      },
      {
        id: 'db5_fullbody',
        order: 5,
        nameVi: 'Toàn Thân — Deadlift · Core · Phục hồi',
        focusVi: 'Toàn thân · Deadlift · Core',
        emoji: '🔥',
        exercises: [
