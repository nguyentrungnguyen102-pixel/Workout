...
export const PROGRAM_TEMPLATES: WorkoutProgram[] = [
  ...
  {
    id: 'dumbbell_home_5x',
    nameVi: 'Tạ Đơn Trung Cấp 5x',
    descriptionVi: 'Upper/Lower split 5 buổi/tuần với tạ đơn. Tăng cơ toàn thân, phù hợp người đã tập cơ bản.',
    emoji: '🏋️',
    daysPerWeek: 5,
    difficulty: 'intermediate',
    focus: 'strength',
    ...
    days: [
      {
        ...
        emoji: '💪',
        exercises: [
          { presetId: 'db_chest_press',    nameVi: 'Đẩy tạ nằm sàn (ngực)',    sets: 4, reps: 10, unit: 'reps' },
          { presetId: 'db_chest_fly',      nameVi: 'Bay tạ nằm sàn (ngực)',    sets: 3, reps: 12, unit: 'reps' },
      ...
      },
      {
        ...
        emoji: '🦵',
        exercises: [
          { presetId: 'db_goblet_squat', nameVi: 'Squat ôm tạ (đùi)',           sets: 4, reps: 12, unit: 'reps' },
          { presetId: 'db_lunge',        nameVi: 'Lunge tạ (đùi mông)',         sets: 3, reps: 12, unit: 'reps' },
          { presetId: 'db_sumo_squat',   nameVi: 'Squat sumo tạ (mông)',        sets: 3, reps: 15, unit: 'reps' },
          { presetId: 'plank',           nameVi: 'Plank',                       sets: 3, durationSeconds: 60, unit: 'seconds' },
          { presetId: 'leg_raise',       nameVi: 'Nâng chân thẳng',            sets: 3, reps: 15, unit: 'reps' },
        ],
      },
      {
        id: 'db5_upper_b',
        ...
        emoji: '🤸',
        exercises: [
          { presetId: 'db_bent_row',      nameVi: 'Kéo tạ cúi người (lưng)',   sets: 4, reps: 10, unit: 'reps' },
      ...
      },
      {
        ...
        order: 4,
        nameVi: 'Thân Dưới B',
        focusVi: 'Sau đùi · Mông · Core',
        emoji: '🍑',
        exercises: [
          { presetId: 'db_rdl',       nameVi: 'Deadlift tạ Romania (sau đùi)', sets: 4, reps: 10, unit: 'reps' },
          { presetId: 'db_hip_thrust',nameVi: 'Hip thrust tạ (mông)',          sets: 4, reps: 15, unit: 'reps' },
          { presetId: 'db_deadlift',  nameVi: 'Deadlift tạ đôi (toàn thân)',  sets: 3, reps: 10, unit: 'reps' },
      ...
      },
      {
        id: 'db5_peak',
        order: 5,
        nameVi: 'Full Body Peak',
        focusVi: 'Toàn thân · Compound',
        emoji: '🏆',
        exercises: [
          { presetId: 'db_deadlift',       nameVi: 'Deadlift tạ đôi (toàn thân)',  sets: 4, reps: 8,  unit: 'reps' },
